/* Restaurant/Food Truck Example - shared frontend configuration */
window.RESTAURANT_SYSTEM = {
  appName: 'Restaurant/Food Truck Example Ordering System',
  businessName: 'Restaurant/Food Truck Example',
